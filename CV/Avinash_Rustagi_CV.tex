...
School of Electrical and Computer Engineering & \url{https://avinashrustagi.github.io} \\ 
...
\item {\bf Avinash Rustagi}, Iacopo Bertelli, Toeno van der Sar, and Pramey Upadhayaya - \textit{Sensing chiral magnetic noise via quantum impurity relaxometry} \href{https://arxiv.org/abs/2009.05060}{\bf [arXiv 2009.05060 (2020)]}.

\item R. L. Wilmington, H. Ardekani, {\bf A. Rustagi}, A. Bataller, A. F. Kemper, R. A. Younts, and K. Gundogdu - \textit{Fermi liquid theory sheds light on ``Hot" EHL in 1L-MoS$_2$}{\bf [Under review (2020)]}.
...
\begin{etaremune}
\itemsep-0.05em
\item A. B. Solanki, S. Bogdanov, {\bf A. Rustagi}, N. Dilley, T. Shen, P. Debashish, Z.Chen, J. Appenzellar, Y. Chen, V. Shalaev, and P. Upadhyaya - \textit{Electrical field control of quantum defect spin-magnon interaction} \href{}{\bf (2020)}.

\item Mohammad Mushfiqur Rahman, {\bf Avinash Rustagi}, Yaroslav Tserkovnyak, and Pramey Upadhyaya - \textit{Electrical excitation of magnons in antiferromagnetically coupled domain wall waveguides} \href{}{\bf (2020)}.

 \item {\bf Avinash Rustagi}, Shivam Kajale, and Pramey Upadhyaya - \textit{Coherently driving quantum spins via electrically induced non-linear magnetization precessions: a pathway towards high Q-factors} \href{}{\bf (2020)}.
...
\item Center for Condensed Matter Sciences (CCMS) Summer Fellowship, Univ. of Florida (2011).
...
\begin{itemize}
\item Teaching Assistant, PHY 2053 Lab, Department of Physics, University of Florida (2010-2011).
\item Substitute Teaching Assistant, PHY 2054, Department of Physics, University of Florida (Fall 2015).
\end{itemize}
